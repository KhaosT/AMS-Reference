    ...
    func updateInfoWithData(data:NSData!) {
        if let data = data {
            ...
            case 0x00:
                ...
                let type = AMSPlayerDataType.fromRaw(rawData.read(1) as Byte) as AMSPlayerDataType
                switch type {
                case .Name:
            ...
            case 0x01:
                ...
                let type = AMSQueueDataType.fromRaw(rawData.read(1) as Byte) as AMSQueueDataType
                switch type {
                case .Index:
